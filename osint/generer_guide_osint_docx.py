...
def build():
    ...
    # Métadonnées document (remplace le défaut "python-docx")
    from datetime import datetime, timezone

    now = datetime.now(timezone.utc)
    props = doc.core_properties
    props.author = "ABOU SAYABOU"
    props.last_modified_by = "ABOU SAYABOU"
    props.title = "Les 10 outils et sites OSINT qu’un expert doit connaître"
    props.subject = "Guide OSINT — installation et usage opérationnel"
    props.category = "Cybersécurité / OSINT"
    props.keywords = "OSINT, cybersécurité, SpiderFoot, Amass, Sherlock, Maltego"
    props.comments = ""  # retire "generated by python-docx"
    ...
    # Purger toute mention python-docx + renseigner Company dans app.xml
    import zipfile
    ...
    with zipfile.ZipFile(buf, "r") as zin, zipfile.ZipFile(
        ...
        for item in zin.infolist():
            ...
            if item.filename == "docProps/core.xml":
                ...
                text = text.replace("python-docx", "ABOU SAYABOU")
                text = text.replace("generated by ABOU SAYABOU", "")
                text = text.replace(
                    "<dc:description>generated by python-docx</dc:description>",
                    "<dc:description></dc:description>",
                )
                # description vide si encore polluée
                text = text.replace(
                    ">generated by ABOU SAYABOU<",
                    "><",
                )
