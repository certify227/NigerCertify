...
1. Burkina, Mali, Sénégal (même devise XOF) — partiel (Niamey↔Ouagadougou/Bamako live ; Dakar/Bobo/Cotonou/Lomé bientôt)
2. Multi-langue FR / HA / Zarma — élargi (nav + hero + USP + paiement)
...
5. Sandbox Mobile Money + SMS/OTP provider + compte compagnie — fait (v1.2)
6. Webhook agrégateur sandbox + tableau de bord compagnie + i18n USP — fait (v1.3)
